...
var TextField = function (_a) {
    ...
    return (React__default.createElement(MuiTextField, __assign({ error: error, fullWidth: true, helperText: error ? form.errors[field.name] : "", margin: "normal", onBlur: handleBlur, onChange: handleChange, value: field.value, variant: "outlined" }, props)));
};

var normalize = function (value) { return value.trim().toLowerCase(); };
var EmailField = function (props) {
    return React__default.createElement(TextField, __assign({ autoComplete: "email", normalize: normalize }, props));
};
...
var Input = function (_a) {
    ...
    return (React__default.createElement("div", { className: classes.root },
        React__default.createElement("div", { className: clsx(classes.wrapper, (_b = {},
                _b[classes.fullWidth] = props.fullWidth,
                _b)) },
            React__default.createElement(MuiTextField, __assign({ inputProps: inputProps, margin: margin, variant: variant }, props)),
            loading && React__default.createElement(CircularProgress, { size: 24, className: classes.progress }),
            !loading && onClear && (inputProps === null || inputProps === void 0 ? void 0 : inputProps.value) ? (React__default.createElement(IconButton, { "aria-label": "clear", className: classes.button, onClick: onClear, size: "small" },
...
var Suggestion = function (_a) {
    ...
    return (React__default.createElement(MenuItem, __assign({}, itemProps, { selected: isHighlighted, component: "div", style: {
...
var AutocompleteField = function (_a) {
    ...
    var extractLabel = React.useCallback(function (item) {
        var label;
    ...
    var extractValue = React.useCallback(function (item) {
        var value;
...
var PasswordField = function (props) {
    return (React__default.createElement(TextField, __assign({ type: "password", autoComplete: "current-password" }, props)));
};
...
var RichTextEditorField = function (_a) {
    ...
    var _e = React.useState(RichTextEditor.createEmptyValue()), value = _e[0], setValue = _e[1];
    React.useEffect(function () {
    ...
    var renderEditor = function () {
        return (React__default.createElement(RichTextEditor, __assign({ autoFocus: autoFocus, value: value, onChange: handleChange, placeholder: placeholder, readOnly: disabled }, props)));
    };
    return (React__default.createElement(FormControl, { fullWidth: true, margin: "normal" },
        ...
        React__default.createElement("div", { className: classes.container }, renderEditor()),
        error && (React__default.createElement(FormHelperText, { error: error }, form.errors[field.name]))));
};
var RichTextField = function (props) {
    return RichTextEditor ? React__default.createElement(RichTextEditorField, __assign({}, props)) : null;
};
...
var SelectField = function (_a) {
    ...
    var _c = React.useState(0), labelWidth = _c[0], setLabelWidth = _c[1];
    React.useEffect(function () {
    ...
    return (React__default.createElement(FormControl, { variant: "outlined", fullWidth: true, margin: "normal" },
        React__default.createElement(InputLabel, { ref: inputLabel, htmlFor: field.name }, label),
        React__default.createElement(Select, __assign({ error: error, onBlur: handleBlur, onChange: handleChange, value: field.value, input: React__default.createElement(OutlinedInput, { labelWidth: labelWidth, name: field.name, id: field.name }) }, props),
            empty && (React__default.createElement(MenuItem, { value: "" },
...
var useStyles$3 = styles$1.makeStyles(function (theme) { return ({
    root: {
        display: "flex",
        alignItems: "center",
    },
...
var Button = function (_a) {
    ...
    return (React__default.createElement("div", { className: clsx(classes.root, rootClassName) },
        React__default.createElement("div", { className: clsx(classes.wrapper, (_b = {},
                _b[classes.fullWidth] = fullWidth,
                _b), wrapperClassName) },
            React__default.createElement(MuiButton, __assign({ fullWidth: fullWidth }, props), children),
            loading && (React__default.createElement(CircularProgress, { size: 24, className: classes.buttonProgress })))));
};

var useStyles$4 = styles.makeStyles(function (theme) { return ({
    button: {
...
var SubmitButton = function (props) {
    ...
    return React__default.createElement(Button, __assign({ type: "submit", rootClassName: classes.button }, props));
};
