...
var MuiFab = _interopDefault(require('@material-ui/core/Fab'));
...
var formikMaterialUiElements = require('formik-material-ui-elements');
...
var SortAscIcon = _interopDefault(require('@material-ui/icons/ArrowDropDown'));
var SortDescIcon = _interopDefault(require('@material-ui/icons/ArrowDropUp'));
var IconButton = _interopDefault(require('@material-ui/core/IconButton'));
var EditIcon = _interopDefault(require('@material-ui/icons/Edit'));
var ViewIcon = _interopDefault(require('@material-ui/icons/Visibility'));
...
var ConfirmationDialog = function (_a) {
    ...
    return (React__default.createElement(Dialog, { open: open, "aria-labelledby": "confirmation-dialog-title", onClose: onClose },
        ...
        React__default.createElement(DialogContent, null,
            React__default.createElement(DialogContentText, null, message)),
        React__default.createElement(DialogActions, null,
            React__default.createElement(Button, { color: "primary", onClick: onConfirm }, "Yes"),
            onClose ? (React__default.createElement(Button, { color: "secondary", onClick: onClose }, "No")) : null)));
};
...
var Fab = function (_a) {
    var action = _a.action, onClick = _a.onClick, props = __rest(_a, ["action", "onClick"]);
    var classes = useStyles();
    var handleClick = function () {
        onClick(action);
    };
    if (action == "add") {
        return (React__default.createElement(Tooltip, { title: "Add", "aria-label": "Add" },
            React__default.createElement(MuiFab, __assign({ className: classes.fab, color: "primary", "aria-label": "Add", onClick: onClick && handleClick }, props),
                React__default.createElement(AddIcon, null))));
    }
    else {
        return (React__default.createElement(Tooltip, { title: "Delete", "aria-label": "Delete" },
            React__default.createElement(MuiFab, __assign({ className: classes.fab, color: "secondary", "aria-label": "Delete", onClick: onClick && handleClick }, props),
...
var FormDialog = function (_a) {
    var title = _a.title, description = _a.description, fields = _a.fields, data = _a.data, saveObject = _a.saveObject, _b = _a.open, open = _b === void 0 ? false : _b, onClose = _a.onClose;
    var adding = !data || !data.id;
    var readonly = !saveObject;
    var initialValues = fields.reduce(function (values, field) {
        var object = __assign({}, values);
        ...
        return lodash.set(object, field.name, value);
    }, {});
    var validationSchema = ObjectSchema()
        .shape(fields.reduce(function (schema, field) {
        var _a;
        return field.schema ? __assign(__assign({}, schema), (_a = {}, _a[field.name] = field.schema, _a)) : schema;
    }, {}));
    ...
    var handleSubmit = function (values, _a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var transformedValues, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        transformedValues = transformValues(values);
                        if (!(typeof saveObject === "function")) return [3 /*break*/, 2];
                        return [4 /*yield*/, saveObject(__assign(__assign({}, transformedValues), { id: data && data.id }))];
                    case 1:
                        _b.sent();
                        _b.label = 2;
    ...
    var renderField = function (field, index) {
        ...
        if (field.readonly) {
            ...
            return (React__default.createElement(MuiTextField, { key: field.name, id: field.name, name: field.name, label: field.label, value: value, fullWidth: true, variant: "outlined", margin: "normal", disabled: true, multiline: field.multiline }));
        }
        else {
            if (field.type === "autocomplete") {
                if (!field.options) {
                ...
                return (React__default.createElement(formik.Field, { key: field.name, component: formikMaterialUiElements.AutocompleteField, id: field.name, name: field.name, label: field.label, autoFocus: index === 0, required: required, disabled: readonly, connectionName: connectionName, labelPath: labelPath, query: query, valuePath: valuePath }));
            }
            else if (field.type === "select") {
                return (React__default.createElement(formik.Field, { key: field.name, component: formikMaterialUiElements.SelectField, id: field.name, name: field.name, label: field.label, autoFocus: index === 0, required: required, disabled: readonly, options: field.options }));
            }
            else if (field.type === "switch") {
                return (React__default.createElement(formik.Field, { key: field.name, component: formikMaterialUiElements.SwitchField, id: field.name, name: field.name, label: field.label, autoFocus: index === 0, required: required, disabled: readonly, options: field.options }));
            }
            else if (field.type === "editor") {
                return (React__default.createElement(formik.Field, { key: field.name, component: formikMaterialUiElements.RichTextField, id: field.name, name: field.name, label: field.label, autoFocus: index === 0, required: required, disabled: readonly, multiline: field.multiline }));
            }
                ...
                return (React__default.createElement(formik.Field, { key: field.name, component: formikMaterialUiElements.AutocompleteListField, id: field.name, name: field.name, label: field.label, autoFocus: index === 0, required: required, disabled: readonly, connectionName: connectionName, labelPath: labelPath, query: query, valuePath: valuePath }));
            }
            else {
                return (React__default.createElement(formik.Field, { key: field.name, component: formikMaterialUiElements.TextField, id: field.name, name: field.name, label: field.label, autoFocus: index === 0, required: required, disabled: readonly, multiline: field.multiline }));
            }
        }
    };
    ...
    return (React__default.createElement(Dialog, { open: open, "aria-labelledby": "form-dialog-title", onClose: onClose },
        React__default.createElement(formik.Formik, { initialValues: initialValues, enableReinitialize: true, validateOnBlur: false, validationSchema: validationSchema, onSubmit: handleSubmit }, function (_a) {
            var dirty = _a.dirty, submitForm = _a.submitForm, isSubmitting = _a.isSubmitting;
            return (React__default.createElement(formikMaterialUiElements.Form, { noValidate: true },
                React__default.createElement(formikMaterialUiElements.DialogTitle, { id: "form-dialog-title", onClose: onClose }, title),
                React__default.createElement(DialogContent, { dividers: true },
                    React__default.createElement(DialogContentText, null, description),
                    renderFields()),
                React__default.createElement(formikMaterialUiElements.DialogActions, null,
                    isSubmitting ? React__default.createElement(CircularProgress, null) : null,
                    saveObject ? (React__default.createElement(Button, { color: "primary", onClick: submitForm, disabled: !dirty || isSubmitting }, data && data.id ? "Save Changes" : "Create")) : null,
                    onClose ? (React__default.createElement(Button, { color: "secondary", onClick: onClose, disabled: isSubmitting }, readonly ? "Close" : "Cancel")) : null)));
        })));
};
...
var sortAsc = function (fieldName) {
    return (humps.decamelize(fieldName) + "_asc").toUpperCase();
};
var sortDesc = function (fieldName) {
    return (humps.decamelize(fieldName) + "_desc").toUpperCase();
};
var TableHead = function (_a) {
    var fields = _a.fields, sort = _a.sort, onSortChange = _a.onSortChange, _b = _a.selectedObjects, selectedObjects = _b === void 0 ? [] : _b, _c = _a.selectionDisabled, selectionDisabled = _c === void 0 ? false : _c, onToggleSelection = _a.onToggleSelection, _d = _a.actionsHidden, actionsHidden = _d === void 0 ? true : _d, _e = _a.actions, actions = _e === void 0 ? [] : _e;
    var classes = useStyles$1();
    var sortEnabled = Boolean(onSortChange);
    var handleLabelClick = function (field) {
        return function () {
            var sortKey = field.sortKey || field.name;
            var newSort;
    ...
    var renderSortIcon = function (field) {
        var sortKey = field.sortKey || field.name;
        if (sort == sortAsc(sortKey)) {
            return React__default.createElement(SortAscIcon, null);
        }
        else if (sort == sortDesc(sortKey)) {
            return React__default.createElement(SortDescIcon, null);
        }
        else {
            return null;
        }
    ...
    var cells = fields.map(function (field) {
        if (field.hidden)
            return null;
        var sortable = field.sortable === undefined ? true : field.sortable;
        return (React__default.createElement(TableCell, { className: clsx(sortEnabled && sortable && classes.pointer), key: field.name, onClick: sortEnabled && sortable ? handleLabelClick(field) : undefined },
    ...
    var actionCells = [];
    if (!actionsHidden) {
        actionCells.push(React__default.createElement(TableCell, { key: -1, padding: "checkbox" }, "\u00A0"));
    }
    lodash.times(actions.length, function (key) {
        actionCells.push(React__default.createElement(TableCell, { key: key, padding: "checkbox" }, "\u00A0"));
    });
    return (React__default.createElement(MuiTableHead, null,
        React__default.createElement(TableRow$1, null,
            onToggleSelection && (React__default.createElement(TableCell, { padding: "checkbox" },
                React__default.createElement(Checkbox, { checked: selectedObjects.length > 0, onChange: onToggleSelection, disabled: selectionDisabled }))),
            cells,
            actionCells)));
};
...
var TableRow = function (_a) {
    ...
    var renderContent = function (field) {
        if (field.type === "autocompletelist" && field.options) {
            ...
            var value = lodash.get(data, field.name);
            return (React__default.createElement("div", { className: classes.list }, value.edges.map(function (_a) {
                var node = _a.node;
                return (React__default.createElement(core.Chip, { key: node.id, label: lodash.get(node, labelPath_1) }));
            })));
        }
        else {
            return (React__default.createElement(Typography, { className: clsx(deleting && classes.deleting), variant: "body2" }, renderValue(field)));
        }
    };
    var renderFields = function () {
        return fields.map(function (field) {
            return !field.hidden && (React__default.createElement(TableCell, { key: data.id + "-" + field.name }, renderContent(field)));
        });
    };
    var renderButton = function (_a) {
        var title = _a.title, onAction = _a.onAction, icon = _a.icon, disabled = _a.disabled;
        if (deleting)
            return null;
        var iconEl;
        ...
        else if (lodash.isFunction(icon)) {
            iconEl = icon(data);
        }
        var isDisabled = disabled;
        if (lodash.isFunction(disabled)) {
            isDisabled = disabled(data);
        }
        if (iconEl) {
            return (React__default.createElement(Tooltip, { title: title, "aria-label": title },
                React__default.createElement(IconButton, { color: "primary", onClick: function () { return onAction(data); }, disabled: isDisabled }, iconEl)));
        }
        else {
            return (React__default.createElement(Tooltip, { title: title, "aria-label": title },
                React__default.createElement(Button, { color: "primary", onClick: function () { return onAction(data); }, disabled: isDisabled }, title)));
        }
    };
    var renderActions = function () {
        return lodash.map(actions, function (action) {
            return (React__default.createElement(TableCell, { key: action.title, padding: "checkbox" }, renderButton(action)));
        });
    };
    return (React__default.createElement(TableRow$1, { selected: selected },
        onSelect ? (React__default.createElement(TableCell, { padding: "checkbox" }, deleting ? null : (React__default.createElement(Checkbox, { checked: selected, onChange: handleCheckboxChange })))) : null,
        renderFields(),
        onEdit ? (React__default.createElement(TableCell, { padding: "checkbox" }, deleting ? null : (React__default.createElement(Tooltip, { title: editable ? "Edit" : "View", "aria-label": editable ? "Edit" : "View" },
            React__default.createElement(IconButton, { color: "primary", onClick: handleEditClick }, editable ? React__default.createElement(EditIcon, null) : React__default.createElement(ViewIcon, null)))))) : null,
        renderActions()));
};

var VisibilityTrigger = function (_a) {
    var onVisible = _a.onVisible;
    var visibilityEl = React.useRef(null);
    var onScreen = useOnScreen(visibilityEl);
    React.useEffect(function () {
        if (onScreen) {
            onVisible();
        }
    }, [onScreen, onVisible]);
    return React__default.createElement("div", { ref: visibilityEl });
};
...
var ResultTable = function (_a) {
    var result = _a.result, connectionName = _a.connectionName, fields = _a.fields, sort = _a.sort, onSortChange = _a.onSortChange, _b = _a.selectedObjects, selectedObjects = _b === void 0 ? [] : _b, _c = _a.objectsDeleting, objectsDeleting = _c === void 0 ? [] : _c, onSelect = _a.onSelect, onToggleSelection = _a.onToggleSelection, onEdit = _a.onEdit, _d = _a.editable, editable = _d === void 0 ? false : _d, actions = _a.actions;
    var classes = useStyles$3();
    var fetching = result.networkStatus < 7;
    var fetchingMore = result.networkStatus === 3;
    var connection = lodash.get(result.data, connectionName, {});
    var _e = connection.edges, edges = _e === void 0 ? [] : _e, _f = connection.pageInfo, pageInfo = _f === void 0 ? {} : _f;
    var fetchMore = React.useCallback(function () {
        var cursor = lodash.get(connection, "pageInfo.endCursor");
        result.fetchMore({
            variables: {
                cursor: cursor,
            },
            updateQuery: function (previousResult, _a) {
                ...
                var newConnection = lodash.get(fetchMoreResult, connectionName);
                var _b = newConnection.edges, newEdges = _b === void 0 ? [] : _b, pageInfo = newConnection.pageInfo;
                if (newEdges.length === 0) {
                    return previousResult;
                }
                var previousConnection = lodash.get(previousResult, connectionName);
                var result = {
                    __typename: previousConnection.__typename,
                    edges: __spreadArrays(previousConnection.edges, newEdges),
                    pageInfo: pageInfo,
                };
                return lodash.set({}, connectionName, result);
            },
        });
    ...
    var renderRows = function () {
        return edges.map(function (_a) {
            var node = _a.node;
            var selected = Boolean(lodash.find(selectedObjects, { id: node.id }));
            var deleting = Boolean(lodash.find(objectsDeleting, { id: node.id }));
            return (React__default.createElement(TableRow, { key: node.id, data: node, fields: fields, selected: selected, onSelect: onSelect, onEdit: onEdit, editable: editable, deleting: deleting, actions: actions }));
        });
    };
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Table, null,
            React__default.createElement(TableHead, { fields: fields, sort: sort, onSortChange: onSortChange, selectedObjects: selectedObjects, selectionDisabled: fetching, onToggleSelection: onToggleSelection, actionsHidden: !onEdit, actions: actions }),
            React__default.createElement(TableBody, null, renderRows())),
        !fetching && result.error && (React__default.createElement(Grid, { container: true, justify: "center" },
            React__default.createElement(Grid, { item: true },
                React__default.createElement(Typography, { className: clsx([classes.message, classes.error]), variant: "body1" }, String(result.error))))),
        !fetching && edges.length == 0 && (React__default.createElement(Grid, { container: true, justify: "center" },
            React__default.createElement(Grid, { item: true },
                React__default.createElement(Typography, { className: classes.message, variant: "body2" }, "No results!")))),
        fetchingMore && React__default.createElement(LinearProgress, null),
        !fetching && pageInfo.hasNextPage && (React__default.createElement(VisibilityTrigger, { onVisible: fetchMore }))));
};

var SearchField = function (_a) {
    var _b = _a.value, value = _b === void 0 ? "" : _b, onSearchValueChange = _a.onSearchValueChange, _c = _a.debounceWait, debounceWait = _c === void 0 ? 500 : _c, onSearch = _a.onSearch, props = __rest(_a, ["value", "onSearchValueChange", "debounceWait", "onSearch"]);
    var search;
    if (typeof onSearch === "function") {
        search = lodash.debounce(onSearch, debounceWait);
    }
    ...
    return (React__default.createElement(MuiTextField, __assign({ variant: "outlined", placeholder: "Search", InputProps: {
...
var GraphqlTable = function (_a) {
    var title = _a.title, typeName = _a.typeName, fields = _a.fields, query = _a.query, queryVariables = _a.queryVariables, connectionName = _a.connectionName, saveMutation = _a.saveMutation, saveResultExtractor = _a.saveResultExtractor, editDisabled = _a.editDisabled, deleteMutation = _a.deleteMutation, mutationVariables = _a.mutationVariables, searchVariable = _a.searchVariable, initialSearch = _a.initialSearch, sortVariable = _a.sortVariable, initialSort = _a.initialSort, _b = _a.multiselect, multiselect = _b === void 0 ? true : _b, _c = _a.onSuccess, onSuccess = _c === void 0 ? noop : _c, _d = _a.onError, onError = _d === void 0 ? noop : _d, onResult = _a.onResult, onAddClick = _a.onAddClick, onAdded = _a.onAdded, onEditClick = _a.onEditClick, onEdited = _a.onEdited, onDeleteClick = _a.onDeleteClick, onDeleted = _a.onDeleted, props = __rest(_a, ["title", "typeName", "fields", "query", "queryVariables", "connectionName", "saveMutation", "saveResultExtractor", "editDisabled", "deleteMutation", "mutationVariables", "searchVariable", "initialSearch", "sortVariable", "initialSort", "multiselect", "onSuccess", "onError", "onResult", "onAddClick", "onAdded", "onEditClick", "onEdited", "onDeleteClick", "onDeleted"]);
    var _e = React.useState(), searchString = _e[0], setSearchString = _e[1];
    var _f = React.useState(), activeSort = _f[0], setActiveSort = _f[1];
    var _g = React.useState([]), selectedObjects = _g[0], setSelectedObjects = _g[1];
    var _h = React.useState(), activeObject = _h[0], setActiveObject = _h[1];
    var _j = React.useState([]), objectsDeleting = _j[0], setObjectsDeleting = _j[1];
    var _k = React.useState(), currentAction = _k[0], setCurrentAction = _k[1];
    ...
    var loading = result.networkStatus === 1;
    var fetchingMore = result.networkStatus === 3;
    var polling = result.networkStatus === 6;
    var fetching = result.networkStatus < 7;
    var editable = Boolean(saveMutation);
    var selectable = Boolean(deleteMutation);
    var adding = currentAction == "add";
    var editing = currentAction == "edit";
    var deleting = currentAction == "delete";
    var handleSearch = function (searchString) {
        var variables = __assign({}, queryVariables);
        if (searchVariable) {
    ...
    var handleSortChange = function (activeSort) {
    ...
    var handleSelect = function (object) {
        var objects = __spreadArrays(selectedObjects);
        if (multiselect) {
            var obj = lodash.find(objects, { id: object.id });
            if (obj) {
                lodash.remove(objects, { id: object.id });
            }
            else {
                objects.push(object);
            }
    ...
    var handleToggleSelection = function () {
        if (selectedObjects.length > 0) {
            setSelectedObjects([]);
        }
        else {
            var objects = lodash(result.data)
                .get(connectionName + ".edges", [])
                .map(function (edge) { return edge.node; });
            setSelectedObjects(objects);
        }
    };
    var handleEdit = function (object) {
    ...
    var handleSave = function (saveObject) {
        return function (values) { return __awaiter(void 0, void 0, void 0, function () {
            var mutationResult, extraVariables, saveResult, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, saveObject({
                                variables: __assign(__assign({}, values), extraVariables),
                            })];
                    case 1:
                    ...
                    case 2:
                        ...
                        throw err_1;
                    case 3: return [2 /*return*/, mutationResult];
                }
            });
        }); };
    };
    var handleDelete = function (deleteObjects) {
        return function () { return __awaiter(void 0, void 0, void 0, function () {
            var ids, deleteResult, extraVariables, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ids = selectedObjects.map(function (object) { return object.id; });
                        setObjectsDeleting(__spreadArrays(selectedObjects));
                        setSelectedObjects([]);
                        handleDialogClose();
                        _a.label = 1;
                    case 1:
                        ...
                        return [4 /*yield*/, deleteObjects({
                                variables: __assign({ ids: ids }, extraVariables),
                            })];
                    case 2:
                        deleteResult = _a.sent();
                        if (typeof onDeleted === "function") {
                            onDeleted(__spreadArrays(selectedObjects));
                        }
                        return [4 /*yield*/, result.refetch(variables)];
                    case 3:
                        _a.sent();
                        onSuccess(ids.length + " " + pluralize(typeName.toLowerCase(), ids.length) + " deleted.");
                        return [3 /*break*/, 6];
                    case 4:
                        err_2 = _a.sent();
                        onError("There was a problem deleting " + pluralize(typeName.toLowerCase(), ids.length) + "!");
                        throw err_2;
                    case 5:
                        setObjectsDeleting([]);
                        return [7 /*endfinally*/];
                    case 6: return [2 /*return*/, deleteResult];
                }
            });
        }); };
    };
    var handleFabClick = function (action) {
        setActiveObject({});
        if (action === "add" && typeof onAddClick === "function") {
            onAddClick();
        }
        else if (action === "delete" && typeof onDeleteClick === "function") {
            onDeleteClick(__spreadArrays(selectedObjects));
        }
        else {
    ...
    var renderFab = function () {
        if (deleteMutation && selectedObjects.length > 0) {
            return React__default.createElement(Fab, { action: "delete", onClick: handleFabClick });
        }
        if (saveMutation) {
            return React__default.createElement(Fab, { action: "add", onClick: handleFabClick });
        }
        return null;
    };
    var renderFormDialog = function () {
        var title;
        var description;
    ...
    var renderDeleteConfirmationDialog = function () {
        if (deleteMutation) {
            var title_1 = "Delete " + pluralize(typeName, selectedObjects.length);
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Toolbar, { disableGutters: true },
            React__default.createElement(Typography, { className: classes.title, variant: "h6" }, title),
            fetching && React__default.createElement(CircularProgress, null),
            searchVariable && (React__default.createElement(SearchField, { className: classes.searchField, value: searchString, onSearchValueChange: setSearchString, onSearch: handleSearch, disabled: loading || fetchingMore || polling }))),
        selectable ? (React__default.createElement(Typography, { className: classes.tableCellHead },
            selectedObjects.length,
            " selected")) : null,
        React__default.createElement(ResultTable, __assign({ result: result, connectionName: connectionName, fields: fields, sort: activeSort, onSortChange: handleSortChange, selectedObjects: selectedObjects, objectsDeleting: objectsDeleting, onSelect: selectable ? handleSelect : undefined, onToggleSelection: selectable ? handleToggleSelection : undefined, onEdit: editDisabled ? undefined : handleEdit, editable: editable }, props)),
        renderFormDialog(),
        renderDeleteConfirmationDialog(),
        renderFab()));
};

exports.default = GraphqlTable;
