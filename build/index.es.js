import React, { useRef, useEffect, useMemo, useCallback, cloneElement, Component, useReducer, useContext, useState } from 'react';
...
var TextField = function (_a) {
    var field = _a.field, form = _a.form, _b = _a.normalize, normalize = _b === void 0 ? identity : _b, props = __rest(_a, ["field", "form", "normalize"]);
    ...
    return (React.createElement(MuiTextField, __assign({ error: error, fullWidth: true, helperText: error ? form.errors[field.name] : "", margin: "normal", onBlur: handleBlur, onChange: handleChange, value: field.value, variant: "outlined" }, props)));
};

var normalize = function (value) { return value.trim().toLowerCase(); };
var EmailField = function (props) {
    return React.createElement(TextField, __assign({ autoComplete: "email", normalize: normalize }, props));
};
...
/* istanbul ignore next */
null : getPropTypesValidator(useSelect, propTypes$1);
...
/* istanbul ignore next */
null : getPropTypesValidator(useCombobox, propTypes$1$1);
...
var _a$1 = Object.prototype, toString = _a$1.toString, hasOwnProperty$1 = _a$1.hasOwnProperty;
...
var Input = function (_a) {
    var _b;
    var loading = _a.loading, _c = _a.margin, margin = _c === void 0 ? "dense" : _c, onClear = _a.onClear, inputProps = _a.inputProps, _d = _a.variant, variant = _d === void 0 ? "outlined" : _d, props = __rest(_a, ["loading", "margin", "onClear", "inputProps", "variant"]);
    var classes = useStyles();
    if (inputProps && !inputProps.value) {
        inputProps.value = "";
    }
    return (React.createElement("div", { className: classes.root },
        React.createElement("div", { className: clsx(classes.wrapper, (_b = {},
                _b[classes.fullWidth] = props.fullWidth,
                _b)) },
            React.createElement(MuiTextField, __assign({ inputProps: inputProps, margin: margin, variant: variant }, props)),
            loading && React.createElement(CircularProgress, { size: 24, className: classes.progress }),
            !loading && onClear && (inputProps === null || inputProps === void 0 ? void 0 : inputProps.value) ? (React.createElement(IconButton, { "aria-label": "clear", className: classes.button, onClick: onClear, size: "small" },
                React.createElement(ClearIcon, null))) : null)));
};

var Suggestion = function (_a) {
    var highlightedIndex = _a.highlightedIndex, index = _a.index, itemProps = _a.itemProps, label = _a.label, selectedItem = _a.selectedItem, value = _a.value;
    var isHighlighted = highlightedIndex === index;
    var isSelected = selectedItem && selectedItem.value === value;
    return (React.createElement(MenuItem, __assign({}, itemProps, { selected: isHighlighted, component: "div", style: {
...
var AutocompleteField = function (_a) {
    ...
    var refetch = lodash.debounce(result.refetch, 300);
    var extractLabel = useCallback(function (item) {
        var label;
        if (typeof labelExtractor === "function") {
            label = labelExtractor(item);
        }
        if (!label) {
            label = lodash.get(item, labelPath);
        }
        return label;
    }, [labelPath, labelExtractor]);
    var extractValue = useCallback(function (item) {
        var value;
    ...
    var renderDownshift = function (downshift) {
        ...
        var _a = getInputProps({
            ...
            onChange: function (event) {
                ...
                if (event.target.value === "") {
                    ...
                    refetch((_a = {},
                        _a[searchVariable] = event.target.value,
                        _a));
                }
            },
            onFocus: openMenu,
        ...
        return (React.createElement("div", { className: classes.container },
            React.createElement(Input, __assign({ error: error, fullWidth: true, 
            ...
            React.createElement(Popper, { anchorEl: inputEl.current, open: isOpen, style: { zIndex: 1400 } },
                React.createElement("div", __assign({}, (isOpen ? getMenuProps({}, { suppressRefError: true }) : {})),
                    React.createElement(Paper, { square: true, style: {
                            marginTop: 8,
                            width: inputEl.current
                                ? inputEl.current.clientWidth
                                : undefined,
                        } }, suggestions.map(function (suggestion, index) { return (React.createElement(Suggestion, { highlightedIndex: highlightedIndex, index: index, itemProps: getItemProps({ item: suggestion }), key: suggestion.value, label: suggestion.label, selectedItem: selectedItem, value: suggestion.value })); }))))));
    };
    return (React.createElement(Downshift, { itemToString: function (item) { return (item ? item.label : ""); }, onChange: handleChange, selectedItem: selectedItem }, renderDownshift));
};

var PasswordField = function (props) {
    return (React.createElement(TextField, __assign({ type: "password", autoComplete: "current-password" }, props)));
};

var RichTextEditor = typeof window !== "undefined" ? require("react-rte").default : null;
...
var RichTextEditorField = function (_a) {
    var _b = _a.autoFocus, autoFocus = _b === void 0 ? false : _b, _c = _a.disabled, disabled = _c === void 0 ? false : _c, field = _a.field, form = _a.form, _d = _a.format, format = _d === void 0 ? "html" : _d, label = _a.label, placeholder = _a.placeholder, props = __rest(_a, ["autoFocus", "disabled", "field", "form", "format", "label", "placeholder"]);
    var classes = useStyles$2();
    var _e = useState(RichTextEditor.createEmptyValue()), value = _e[0], setValue = _e[1];
    useEffect(function () {
    ...
    var renderEditor = function () {
        return (React.createElement(RichTextEditor, __assign({ autoFocus: autoFocus, value: value, onChange: handleChange, placeholder: placeholder, readOnly: disabled }, props)));
    };
    return (React.createElement(FormControl, { fullWidth: true, margin: "normal" },
        React.createElement(InputLabel, { htmlFor: field.name, shrink: true }, label),
        React.createElement("div", { className: classes.container }, renderEditor()),
        error && (React.createElement(FormHelperText, { error: error }, form.errors[field.name]))));
};
var RichTextField = function (props) {
    return RichTextEditor ? React.createElement(RichTextEditorField, __assign({}, props)) : null;
};

var SelectField = function (_a) {
    var options = _a.options, field = _a.field, form = _a.form, label = _a.label, empty = _a.empty, _b = _a.normalize, normalize = _b === void 0 ? function (v) { return v; } : _b, props = __rest(_a, ["options", "field", "form", "label", "empty", "normalize"]);
    var error = form.errors[field.name] && form.touched[field.name];
    ...
    return (React.createElement(FormControl, { variant: "outlined", fullWidth: true, margin: "normal" },
        React.createElement(InputLabel, { ref: inputLabel, htmlFor: field.name }, label),
        React.createElement(Select, __assign({ error: error, onBlur: handleBlur, onChange: handleChange, value: field.value, input: React.createElement(OutlinedInput, { labelWidth: labelWidth, name: field.name, id: field.name }) }, props),
            empty && (React.createElement(MenuItem, { value: "" },
...
var useStyles$3 = makeStyles$2(function (theme) { return ({
    root: {
        display: "flex",
        alignItems: "center",
    },
...
var Button = function (_a) {
    var _b;
    var children = _a.children, rootClassName = _a.rootClassName, wrapperClassName = _a.wrapperClassName, _c = _a.loading, loading = _c === void 0 ? false : _c, _d = _a.fullWidth, fullWidth = _d === void 0 ? false : _d, props = __rest(_a, ["children", "rootClassName", "wrapperClassName", "loading", "fullWidth"]);
    var classes = useStyles$3();
    return (React.createElement("div", { className: clsx(classes.root, rootClassName) },
        React.createElement("div", { className: clsx(classes.wrapper, (_b = {},
                _b[classes.fullWidth] = fullWidth,
                _b), wrapperClassName) },
            React.createElement(MuiButton, __assign({ fullWidth: fullWidth }, props), children),
...
var SubmitButton = function (props) {
    ...
    return React.createElement(Button, __assign({ type: "submit", rootClassName: classes.button }, props));
};

var SwitchField = function (_a) {
    var field = _a.field, form = _a.form, label = _a.label, props = __rest(_a, ["field", "form", "label"]);
    var handleChange = function (event) {
