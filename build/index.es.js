...
var ConfirmationDialog = function (_a) {
    ...
    return (React.createElement(Dialog, { open: open, "aria-labelledby": "confirmation-dialog-title", onClose: onClose },
        ...
        React.createElement(DialogActions, null,
            React.createElement(Button, { color: "primary", onClick: onConfirm }, "Yes"),
            onClose ? (React.createElement(Button, { color: "secondary", onClick: onClose }, "No")) : null)));
};
...
var Fab = function (_a) {
    ...
    if (action == "add") {
        return (React.createElement(Tooltip, { title: "Add", "aria-label": "Add" },
            React.createElement(MuiFab, __assign({ className: classes.fab, color: "primary", "aria-label": "Add", onClick: onClick && handleClick }, props),
                React.createElement(AddIcon, null))));
    }
    else {
        return (React.createElement(Tooltip, { title: "Delete", "aria-label": "Delete" },
            React.createElement(MuiFab, __assign({ className: classes.fab, color: "secondary", "aria-label": "Delete", onClick: onClick && handleClick }, props),
...
var FormDialog = function (_a) {
    ...
    return (React.createElement(Dialog, { open: open, "aria-labelledby": "form-dialog-title", onClose: onClose },
        React.createElement(Formik, { initialValues: initialValues, enableReinitialize: true, validateOnBlur: false, validationSchema: validationSchema, onSubmit: handleSubmit }, function (_a) {
            var dirty = _a.dirty, submitForm = _a.submitForm, isSubmitting = _a.isSubmitting;
            return (React.createElement(Form, { noValidate: true },
                React.createElement(DialogTitle$1, { id: "form-dialog-title", onClose: onClose }, title),
                React.createElement(DialogContent, { dividers: true },
                    React.createElement(DialogContentText, null, description),
                    renderFields()),
                React.createElement(DialogActions$1, null,
                    isSubmitting ? React.createElement(CircularProgress, null) : null,
                    saveObject ? (React.createElement(Button, { color: "primary", onClick: submitForm, disabled: !dirty || isSubmitting }, data && data.id ? "Save Changes" : "Create")) : null,
                    onClose ? (React.createElement(Button, { color: "secondary", onClick: onClose, disabled: isSubmitting }, readonly ? "Close" : "Cancel")) : null)));
        })));
};
...
var TableHead = function (_a) {
    ...
    var renderSortIcon = function (field) {
        var sortKey = field.sortKey || field.name;
        if (sort == sortAsc(sortKey)) {
            return React.createElement(SortAscIcon, null);
        }
        else if (sort == sortDesc(sortKey)) {
            return React.createElement(SortDescIcon, null);
        }
        else {
            return null;
        }
    ...
    var cells = fields.map(function (field) {
        ...
        return (React.createElement(TableCell, { className: clsx(sortEnabled && sortable && classes.pointer), key: field.name, onClick: sortEnabled && sortable ? handleLabelClick(field) : undefined },
    ...
    var actionCells = [];
    if (!actionsHidden) {
        actionCells.push(React.createElement(TableCell, { key: -1, padding: "checkbox" }, "\u00A0"));
    }
    lodash.times(actions.length, function (key) {
        actionCells.push(React.createElement(TableCell, { key: key, padding: "checkbox" }, "\u00A0"));
    });
    return (React.createElement(MuiTableHead, null,
        React.createElement(TableRow$1, null,
            onToggleSelection && (React.createElement(TableCell, { padding: "checkbox" },
                React.createElement(Checkbox, { checked: selectedObjects.length > 0, onChange: onToggleSelection, disabled: selectionDisabled }))),
            cells,
            actionCells)));
};
...
var TableRow = function (_a) {
    ...
    var renderActions = function () {
        return lodash.map(actions, function (action) {
            return (React.createElement(TableCell, { key: action.title, padding: "checkbox" }, renderButton(action)));
        });
    };
    return (React.createElement(TableRow$1, { selected: selected },
        onSelect ? (React.createElement(TableCell, { padding: "checkbox" }, deleting ? null : (React.createElement(Checkbox, { checked: selected, onChange: handleCheckboxChange })))) : null,
        renderFields(),
        onEdit ? (React.createElement(TableCell, { padding: "checkbox" }, deleting ? null : (React.createElement(Tooltip, { title: editable ? "Edit" : "View", "aria-label": editable ? "Edit" : "View" },
            React.createElement(IconButton, { color: "primary", onClick: handleEditClick }, editable ? React.createElement(EditIcon, null) : React.createElement(ViewIcon, null)))))) : null,
        renderActions()));
};

var VisibilityTrigger = function (_a) {
    var onVisible = _a.onVisible;
    var visibilityEl = useRef(null);
    ...
    return React.createElement("div", { ref: visibilityEl });
};
...
var ResultTable = function (_a) {
    ...
    var renderRows = function () {
        return edges.map(function (_a) {
            ...
            return (React.createElement(TableRow, { key: node.id, data: node, fields: fields, selected: selected, onSelect: onSelect, onEdit: onEdit, editable: editable, deleting: deleting, actions: actions }));
        });
    };
    return (React.createElement(React.Fragment, null,
        React.createElement(Table, null,
            React.createElement(TableHead, { fields: fields, sort: sort, onSortChange: onSortChange, selectedObjects: selectedObjects, selectionDisabled: fetching, onToggleSelection: onToggleSelection, actionsHidden: !onEdit, actions: actions }),
            React.createElement(TableBody, null, renderRows())),
        !fetching && result.error && (React.createElement(Grid, { container: true, justify: "center" },
            React.createElement(Grid, { item: true },
                React.createElement(Typography, { className: clsx([classes.message, classes.error]), variant: "body1" }, String(result.error))))),
        !fetching && edges.length == 0 && (React.createElement(Grid, { container: true, justify: "center" },
            React.createElement(Grid, { item: true },
                React.createElement(Typography, { className: classes.message, variant: "body2" }, "No results!")))),
        fetchingMore && React.createElement(LinearProgress, null),
        !fetching && pageInfo.hasNextPage && (React.createElement(VisibilityTrigger, { onVisible: fetchMore }))));
};
...
var SearchField = function (_a) {
    ...
    return (React.createElement(MuiTextField, __assign({ variant: "outlined", placeholder: "Search", InputProps: {
...
var GraphqlTable = function (_a) {
    ...
    var _f = useState(), activeSort = _f[0], setActiveSort = _f[1];
    var _g = useState([]), selectedObjects = _g[0], setSelectedObjects = _g[1];
    var _h = useState(), activeObject = _h[0], setActiveObject = _h[1];
    var _j = useState([]), objectsDeleting = _j[0], setObjectsDeleting = _j[1];
    var _k = useState(), currentAction = _k[0], setCurrentAction = _k[1];
    ...
    var renderFab = function () {
        if (deleteMutation && selectedObjects.length > 0) {
            return React.createElement(Fab, { action: "delete", onClick: handleFabClick });
        }
        if (saveMutation) {
            return React.createElement(Fab, { action: "add", onClick: handleFabClick });
        }
        return null;
    };
    var renderFormDialog = function () {
        ...
        if (saveMutation) {
            return (React.createElement(Mutation, { mutation: saveMutation }, function (saveObject) { return (React.createElement(FormDialog, { title: title, description: description, fields: fields, data: activeObject, saveObject: handleSave(saveObject), open: adding || editing, onClose: handleDialogClose })); }));
        }
        else {
            return (React.createElement(FormDialog, { title: title, description: description, fields: fields, data: activeObject, open: adding || editing, onClose: handleDialogClose }));
        }
    };
    var renderDeleteConfirmationDialog = function () {
        if (deleteMutation) {
            ...
            return (React.createElement(Mutation, { mutation: deleteMutation }, function (deleteObjects) { return (React.createElement(ConfirmationDialog, { title: title_1, message: message_1, onConfirm: handleDelete(deleteObjects), open: deleting, onClose: handleDialogClose })); }));
        }
        return null;
    };
    return (React.createElement(React.Fragment, null,
        React.createElement(Toolbar, { disableGutters: true },
            ...
            fetching && React.createElement(CircularProgress, null),
            searchVariable && (React.createElement(SearchField, { className: classes.searchField, value: searchString, onSearchValueChange: setSearchString, onSearch: handleSearch, disabled: loading || fetchingMore || polling }))),
        selectable ? (React.createElement(Typography, { className: classes.tableCellHead },
            selectedObjects.length,
            " selected")) : null,
        React.createElement(ResultTable, __assign({ result: result, connectionName: connectionName, fields: fields, sort: activeSort, onSortChange: handleSortChange, selectedObjects: selectedObjects, objectsDeleting: objectsDeleting, onSelect: selectable ? handleSelect : undefined, onToggleSelection: selectable ? handleToggleSelection : undefined, onEdit: editDisabled ? undefined : handleEdit, editable: editable }, props)),
        renderFormDialog(),
